package tech.mobiledeveloper.mfti.data

import kotlinx.coroutines.delay
import tech.mobiledeveloper.mfti.screen.main.Restaurant
import javax.inject.Inject

class RestaurantRepository @Inject constructor() {

    suspend fun fetchNearest(): List<Restaurant> {
        delay(2000)
    ...
    suspend fun fetchPopular(): List<Restaurant> {
        delay(3000)
